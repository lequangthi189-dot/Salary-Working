...
export const translations = {
  en: {
    ...
    "shiftForm.addPlanned": "Add planned shift only",
    "shiftForm.addPlannedHint":
      "Creates a planned (un-clocked) shift from the scheduled times above — no check-in/out yet.",
  ...
  vi: {
    ...
    "shiftForm.addPlanned": "Chỉ thêm lịch dự kiến",
    "shiftForm.addPlannedHint":
      "Tạo ca DỰ KIẾN (chưa chấm công) từ giờ lịch ở trên — chưa cần giờ vào/ra.",

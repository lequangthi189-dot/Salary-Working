...
export const translations = {
  en: {
    ...
    "theme.label": "Theme",
    "theme.dark": "Sleek Dark",
    "theme.glass": "Glassmorphism",
    "theme.neumorph": "Soft UI",
    "common.yes": "Yes",
    "common.no": "No",
    ...
    "monthStats.shortfall": "Late in/early out: ~{amount} less than working the full schedule (reference only, not deducted)",
    "monthStats.onSchedule": "✓ On schedule — no shortfall",
  ...
  vi: {
    ...
    "theme.label": "Phong cách",
    "theme.dark": "Tối tối giản",
    "theme.glass": "Kính mờ",
    "theme.neumorph": "Soft UI (mềm)",
    "common.yes": "Có",
    "common.no": "Không",
    ...
    "monthStats.shortfall": "Đi trễ/về sớm: nhận ít hơn ~{amount} so với làm đủ lịch (chỉ tham khảo, không bị trừ)",
    "monthStats.onSchedule": "✓ Đủ giờ theo lịch",
